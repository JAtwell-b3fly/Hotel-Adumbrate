            ...
            <div className="background_image">
                <div className="hotel_stamp">
                    ...
                    <div style={{marginLeft:"1rem"}}>
                        <h3  className="browse_welcome" style={{fontWeight: "900", color: "white"}}>Hi {userInfo.fullName}, Let us help you manage hotel adumbrate</h3>
                    </div>
                ...
                <div className="admin_dashboard_box">
                    <div className="admin_dashboard_left">
                        <button
                            style={{borderStyle:"none", backgroundColor:"whitesmoke", marginBottom: "0.5rem", borderRadius: "15rem", height: "10rem"}}
                        ...
                        >
                            ...
                            <p style={{textAlign:"center",fontFamily: 'Cinzel', color:"black", fontSize:"90%", marginTop:"0.5rem", fontWeight: "bold"}}>Manage Rooms</p>
                        </button>
                        ...
                        >
                            ...
                            <p style={{textAlign:"center",fontFamily: 'Cinzel', color:"black", fontSize:"90%", marginTop:"0.5rem", fontWeight: "bold"}}>Add Rooms</p>
                        </button>
                        ...
                        >
                            ...
                            <p style={{textAlign:"center",fontFamily: 'Cinzel', color:"black", fontSize:"90%", marginTop:"0.5rem", fontWeight: "bold"}}>Manage Reservations</p>
                        </button>
